...
public class AdapterFinshedOrders extends RecyclerView.Adapter<AdapterFinshedOrders.ViewHolderVidio> {


    private Context mcontext;
    ArrayList<DataFinshOrder> list;
    int layout;

    public AdapterFinshedOrders(Context mcontext, ArrayList<DataFinshOrder> list) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolderVidio holder, final int position) {
        ...
        holder.img_track.setOnClickListener(v -> {
            ...
            intent.putExtra("orderDetailsFinshed", list.get(position));
